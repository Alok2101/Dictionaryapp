...
export default function App() {
  ...
  const RandWordApi =
    "https://api.dictionaryapi.dev/api/v2/entries/en/word.json/randomWords?hasDictionaryDef=true&minCorpusCount=0&minLength=5&maxLength=15&limit=1&api_key=mhvfzxrhb41uag20wv1ycfl20yxq6f5zabdt82eutc2wuf1qf";
